...
export default function Volunteering() {
  return (
    <section id="volunteering" className="section-fx relative py-16 sm:py-24 lg:py-32 bg-black text-white overflow-hidden">
      {/* Background Gradient */}
            ...
            {CV_DATA.volunteering.map((item, index) => (
              ...
              >
                ...
                <div className="absolute left-3 md:left-1/2 transform md:-translate-x-1/2 
                  ...
                  {index === 0 ? (
                    <Landmark className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400" />
                  ) : (
                    <HandHeart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-400" />
                  )}
                </div>
